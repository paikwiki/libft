...
#    Updated: 2020/03/08 22:34:21 by cbaek            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = ft_strlen.c ft_strchr.c ft_strrchr.c ft_strnstr.c ft_atoi.c \
		...
		ft_memchr.c ft_memcmp.c ft_calloc.c ft_strdup.c ft_strtrim.c \
		ft_strjoin.c ft_substr.c ft_split.c ft_putchar_fd.c \
		ft_putstr_fd.c ft_itoa.c ft_putnbr_fd.c ft_putendl_fd.c \
		ft_strmapi.c ft_lstnew.c ft_lstsize.c ft_lstlast.c \
...
OBJS = ft_strlen.o ft_strchr.o ft_strrchr.o ft_strnstr.o ft_atoi.o \
		...
		ft_bzero.o ft_memset.o ft_memcpy.o ft_memccpy.o ft_memmove.o \
		ft_memchr.o ft_memcmp.o ft_calloc.o ft_strdup.o ft_strtrim.o \
		ft_strjoin.o ft_substr.o ft_split.o ft_putchar_fd.o \
		ft_putstr_fd.o ft_itoa.o ft_putnbr_fd.o ft_putendl_fd.o \
		ft_strmapi.o ft_lstnew.o ft_lstsize.o ft_lstlast.o \
